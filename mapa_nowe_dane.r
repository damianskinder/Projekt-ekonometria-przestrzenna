# ============================================================
#  Interaktywna mapa województw - nowe dane
#  Uruchomienie: shiny::runApp("mapa_nowe_dane.r")
# ============================================================
...
ui <- fluidPage(
  ...
  titlePanel("Wizualizacja przestrzenna województw Polski – nowe dane"),
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      sliderInput(
        inputId = "rok",
        label   = "Rok:",
        min     = min(lata_dostepne),
        max     = max(lata_dostepne),
        value   = 2015,
        step    = 1,
        sep     = "",
