# ============================================================
#  Modelowanie przestrzenne — mieszkania oddane do uzytkowania
...
FORMULA <- MO ~ WSK_URB + NAKL + WYNAGR + SM + WSK25_34
...
model_lm_ols <- lm(MO ~ WSK_URB + NAKL + WYNAGR + SM + WSK25_34, data = dane_lm)
...
ggplot(coef_both, aes(x = Zmienna, y = Wspolczynnik, fill = Model)) +
  ...
  labs(title = "Porownanie wspolczynnikow: FE vs SAR",
       subtitle = "Mieszkania oddane do uzytkowania",
